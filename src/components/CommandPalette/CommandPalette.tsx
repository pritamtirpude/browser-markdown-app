...
function CommandPalette() {
  return (
    <motion.div
      ...
      className="dark:bg-markdown-neutral-900 absolute top-full left-1/2 z-50 mt-2 w-70 -translate-x-1/2 rounded-md bg-white p-2 shadow-lg ring-1 ring-black/5 dark:ring-white/10"
    >
